      ...
      <MDBContainer>
        ...
        <MDBBreadcrumbItem active>Details</MDBBreadcrumbItem>
          ...
          <MDBCol size='4' className='d-flex  align-items-stretch'>
            <MDBCard className="p-2 mb-3  w-100">
              <MDBCardBody>
                <MDBCardTitle><h4 className='text-start'>{details?.hotelName}</h4></MDBCardTitle>
                <MDBRow>
                  <div className='text-start'>
                    <p><MDBIcon icon="map-marker-alt" /> {details?.hotelLocation}</p>
                    
                    <h5 className='text-center mt-5'>PKR {details?.roomPrice} </h5>
                    <div className='text-center mt-5'><MDBBtn className='' href={'/hotel/booking/' + details?.id} style={{ backgroundColor: '#F7D402', color: "black" }}>Book Now</MDBBtn></div>
                  </div>
                </MDBRow>
