              ...
              <MDBCardBody>
                ...
                <MDBRow>
                  <div className='text-start'>
                    ...
                    <div className='text-center mt-5'><MDBBtn className='' href={'/home/collaborate-tour/book/' + details?.id} style={{ backgroundColor: '#F7D402', color: "black" }}>Collaborate</MDBBtn></div>
                  </div>
                </MDBRow>
